...
Rust must be installed on your machine: <https://rust-lang.org/tools/install>. You must have this project and Moirai in the same root folder. You can change the path of these dependencies in `Cargo.toml`.
